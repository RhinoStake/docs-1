...
If syncing from genesis, the mainnet version tg is `v1.1.0`.  If syncing from a recent snapshot or [statesync](sync-with-state-sync), then the review the latest [mainnet version tag](joining-mainnet.md).
...
Continue with [Joining Mainet](joining-mainnet.md).
